...
namespace RE
{
	...
	public:
		...
		void UpdateMenuMode(const BSFixedString& a_menuName, bool a_enterMenuMode)
		{
			using func_t = decltype(&UI::UpdateMenuMode);
			REL::Relocation<func_t> func{ REL::ID(241336) };
			return func(this, a_menuName, a_enterMenuMode);
		}
